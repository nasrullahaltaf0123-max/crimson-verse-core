...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "search.noResults": { en: "No donors yet for this group", bn: "এই গ্রুপের জন্য এখনো কোনো ডোনার নেই" },
  "search.adjustFilters": { en: "Be the first to join and save lives.", bn: "প্রথম হন, জীবন বাঁচান।" },
  "search.zeroQuote": { en: "The first chapter begins with you.", bn: "প্রথম অধ্যায় শুরু হবে আপনার দিয়ে।" },
